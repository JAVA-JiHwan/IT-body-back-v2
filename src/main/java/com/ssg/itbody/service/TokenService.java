...
//
//        Long userId = refreshTokenRepository.findByRefreshToken(refreshToken).orElseThrow().getUserId();
//
...
//
//
//    return tokenProvider.generateToken(userEntity, Duration.ofHours(2));
//    }
//}
